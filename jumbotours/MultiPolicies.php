<?php
// Jumbo Tours Group
error_log("\r\nStart Jumbo Tours Group Multi Policies\r\n", 3, "/srv/www/htdocs/error_log");
...
if ($details == "hoteldetails") {
    // Detail level
    $sql = "select data, searchsettings, xmlrequest, xmlresult from quote_session_jtg where session_id='" . $session_id . "-" . $index . "'";
} else {
