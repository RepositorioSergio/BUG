...
if ($city_xml15 != "") {
    ...
    if ($PalladiumHotelGroupserviceurl != "" and $PalladiumHotelGroupusername != "") {
        ...
        for ($r = 0; $r < $rooms; $r ++) {
            ...
            $raw .= '</ns:GuestCounts></ns:RoomStayCandidate></ns:RoomStayCandidates><ns:HotelSearchCriteria><ns:Criterion><ns:HotelRef HotelCode="" AreaID="" HotelCityCode="' . $city_xml15 . '"/></ns:Criterion></ns:HotelSearchCriteria></ns:AvailRequestSegment></ns:AvailRequestSegments></ns:AvailabilityRequest></clo:GetAvailability> </soapenv:Body></soapenv:Envelope>'; // We need to add a space before soapenv otherwise it will not work
            $ch = curl_init();
