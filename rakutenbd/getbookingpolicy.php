...
use Zend\Log\Logger;
use Zend\Log\Writer;
echo "COMECOU GET BOOKING POLICY";
...
$db = new \Zend\Db\Adapter\Adapter($config);
$booking_policy_id = 'cce250be-f992-11ea-9d86-2a2433cc1b81';
$url = 'https://api-v3.rakutentravelxchange.com/booking_policy/' . $booking_policy_id;
