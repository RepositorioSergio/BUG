...
<request>
    ...
    <method action="book" type="cruise" sessionkey="' . $sessionkey . '" status="Live">
    <contact address1="37 Hawbank Road" address2="College Milton" city="East Kilbride" country="GB" county="Glasgow" email="paulo@corp.bug-software.com" firstname="Paulo" lastname="Andrade" postcode="G74 5EG" telephone="01355 246111" title="MISS" />
    <passengers>
        <passenger dob="1973-07-24" title="MISS" firstname="Paulo" middlename="Michael" lastname="Andrade" paxno="1" paxtype="adult" nationality="GB" passport="26347891107" passportstart="2020-02-02" passportexpiry="2022-05-31" travelling="" emergencyname="Richard Smith" emergencyphone="01355 246111" emergencyemail="paulo@corp.bug-software.com" />
        <passenger dob="1973-07-24" title="MR" firstname="Richard" middlename="Michael" lastname="Smith" paxno="2" paxtype="adult" nationality="GB" passport="26347891214" passportstart="2020-01-20" passportexpiry="2022-04-21" travelling="" emergencyname="Richard Smith" emergencyphone="01355 246111" emergencyemail="richard@traveltek.net"/>         
    </passengers>
    <allocation>
