...
<request>
    ...
    <method action="getcruiselines" sitename="' . $mundocrucerosWebsite . '" />
</request>';
    ...
    try {
        ...
        if ($result->valid()) {
            ...
            if ($id > 0) {
                ...
                $where['id = ?'] = $id;
                $update = $sql->update('cruzeiros_linhas', $data, $where);
                $db->getDriver()
                ->getConnection()
                ->disconnect();
            } else {
        ...
        try {
            ...
            if ($result->valid()) {
                ...
                if ($id > 0) {
                    ...
                    $where['id = ?'] = $id;
                    $update = $sql->update('linhas_ship', $data, $where);
                    $db->getDriver()
                    ->getConnection()
                    ->disconnect();
                } else {
