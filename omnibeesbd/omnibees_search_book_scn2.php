...
// Child
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][0]['GuestCountsType']['GuestCounts']['GuestCount'][1]['Age'] = 1;
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][0]['GuestCountsType']['GuestCounts']['GuestCount'][1]['AgeQualifyCode'] = "Child";
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][0]['GuestCountsType']['GuestCounts']['GuestCount'][1]['Count'] = 1;
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][0]['Quantity'] = 1;
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][0]['RPH'] = 0;
//
// Adult
//
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][1]['GuestCountsType']['GuestCounts']['GuestCount'][0]['AgeQualifyCode'] = "Adult";
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][1]['GuestCountsType']['GuestCounts']['GuestCount'][0]['Count'] = 2;
//
// Child
//
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][1]['GuestCountsType']['GuestCounts']['GuestCount'][1]['Age'] = 10;
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][1]['GuestCountsType']['GuestCounts']['GuestCount'][1]['AgeQualifyCode'] = "Child";
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][1]['GuestCountsType']['GuestCounts']['GuestCount'][1]['Count'] = 1;
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][1]['Quantity'] = 1;
$params['ota_HotelAvailRQ']['HotelSearchCriteria']['Criterion']['RoomStayCandidatesType']['RoomStayCandidates']['RoomStayCandidate'][1]['RPH'] = 1;
...
for ($xRooms = 0; $xRooms < $rooms; $xRooms ++) {
    ...
    for ($r = 0; $r < count($RoomRates); $r ++) {
        echo "Room:" . $RoomRates[$r]['RoomID'][$xRooms] . " = " . $RoomID[$xRooms];
        echo $return;
...
for ($r = 0; $r < $rooms; $r ++) {
    ...
    for ($w = 0; $w < $adults[$r]; $w ++) {
        ...
        $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['ResGuestsType']['ResGuests']['ResGuest'][$rS]['Profiles']['ProfileInfos']['ProfileInfo']['Profile']['Customer']['Telephones']['TelephoneInfo']['PhoneLocationType'] = "Home";
        $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['ResGuestsType']['ResGuests']['ResGuest'][$rS]['Profiles']['ProfileInfos']['ProfileInfo']['Profile']['Customer']['Telephones']['TelephoneInfo']['PhoneNumber'] = "215 252 252";
        $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['ResGuestsType']['ResGuests']['ResGuest'][$rS]['Profiles']['ProfileInfos']['ProfileInfo']['Profile']['Customer']['Telephones']['TelephoneInfo']['PhoneTechType'] = "Voice";
        $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['ResGuestsType']['ResGuests']['ResGuest'][$rS]['Profiles']['ProfileInfos']['ProfileInfo']['Profile']['Customer']['Telephones']['TelephoneInfo']['ShareMarketInd'] = "Yes";
        $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['ResGuestsType']['ResGuests']['ResGuest'][$rS]['Profiles']['ProfileInfos']['ProfileInfo']['Profile']['Customer']['Telephones']['TelephoneInfo']['ShareSyncInd'] = "Yes";
        ...
        if ($RoomRates[$r]['RoomID'][$xRooms] == $RoomID[$xRooms]) {
            if ($RoomRates[$r]['RatePlanID'][$xRooms] == $RatePlanID[$xRooms]) {
                if ($RoomRates[$r]['RoomStayCandidateRPH'][$xRooms] == $xRooms) {
                    ...
                    $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RatePlans'][0]['RatePlanID'] = $RatePlanID[$xRooms];
                    ...
                    for ($z = 0; $z < count($rates); $z ++) {
                        ...
                        // Novo
                        if ($rates[$z]['MaxAge'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MaxAge'] = $rates[$z]['MaxAge'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MaxAge'] = null;
                        }
                        if ($rates[$z]['Duration'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['Duration'] = $rates[$z]['Duration'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['Duration'] = null;
                        }
                        if ($rates[$z]['AgeQualifyingCode'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['AgeQualifyingCode'] = $rates[$z]['AgeQualifyingCode'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['AgeQualifyingCode'] = null;
                        }
                        if ($rates[$z]['MaxGuestApplicable'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MaxGuestApplicable'] = $rates[$z]['MaxGuestApplicable'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MaxGuestApplicable'] = null;
                        }
                        if ($rates[$z]['MinAdvancedBookingOffset'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MinAdvancedBookingOffset'] = $rates[$z]['MinAdvancedBookingOffset'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MinAdvancedBookingOffset'] = null;
                        }
                        if ($rates[$z]['MinAge'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MinAge'] = $rates[$z]['MinAge'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MinAge'] = null;
                        }
                        if ($rates[$z]['Status'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['Status'] = $rates[$z]['Status'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['Status'] = null;
                        }
                        if ($rates[$z]['StayThrough'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['StayThrough'] = $rates[$z]['StayThrough'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['StayThrough'] = null;
                        }
                        if ($rates[$z]['NumberOfUnits'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['NumberOfUnits'] = $rates[$z]['NumberOfUnits'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['NumberOfUnits'] = null;
                        }
                        if ($rates[$z]['MinGuestApplicable'] != "") {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MinGuestApplicable'] = $rates[$z]['MinGuestApplicable'];
                        } else {
                            $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomRates']['RoomRate'][0]['RatesType']['Rates']['Rate'][$z]['MinGuestApplicable'] = null;
                        }
                        // EOF Novo
                ...
                $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomTypes']['RoomType'][0]['MaxOccupancy'] = $Rooms[$RoomID[$xRooms]]["MaxOccupancy"];
                $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomTypes']['RoomType'][0]['NumberOfUnits'] = $Rooms[$RoomID[$xRooms]]["NumberOfUnits"];
                ...
                $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RoomTypes']['RoomType'][0]['RoomID'] = $RoomID[$xRooms];
                ...
                $policies = $RatePlans[$RatePlanID[$xRooms]]['PaymentPolicies'];
                // var_dump($policies);
                ...
                // Guarantees
                $guarantees = $RatePlans[$RatePlanID[$xRooms]]['Guarantees2'];
                ...
                echo $return;
                echo "GUARANTEE CODE: " . $guarantees[0]["GuaranteeCode"];
                echo $return;
                //
                // echo $return;
                ...
                // echo $return;
                //
                $additionaldetails = $RatePlans[$RatePlanID[$xRooms]]["AdditionalDetails"];
                ...
                if ($RatePlans[$RatePlanID[$xRooms]]["CurrencyCode"] != "") {
                    $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RatePlans'][0]['CurrencyCode'] = $RatePlans[$RatePlanID[$xRooms]]["CurrencyCode"];
                } else {
                ...
                $cancelpenalties = $RatePlans[$RatePlanID[$xRooms]]["CancelPenalties"];
                echo $return;
                echo "CURRENCY: " . $cancelpenalties[0]["CurrencyCode"];
                echo $return;
                ...
                //COMMISSION
                $commission = $RatePlans[$RatePlanID[$xRooms]]['Commission'];
                if (is_array($commission)) {
                    if (isset($commission[0])) {
                        if (is_array($commission[0])) {
                            
                            if ($commission[0]['Percent'] != ""){
                                $params['ota_HotelResRQ']['HotelReservationsType']['HotelReservations']['HotelReservation']['RoomStaysType']['RoomStays']['RoomStay'][$xRooms]['RatePlans'][0]['Commission']['Percent'] = $commission[0]['Percent'] ;
                            } else {
                ...
                echo $return;
                echo "PERCENT:" . $commission[0]['Percent'];
                echo $return;
                // }
