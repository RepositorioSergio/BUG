...
if ($details == "hoteldetails") {
    // Detail level
    $sql = "select data, searchsettings, xmlrequest, xmlresult from quote_session_actiontravel where session_id='" . $session_id . "-" . $index . "'";
} else {
...
foreach ($breakdownTmp as $k => $v) {
    foreach ($v as $key => $value) {
        ...
        if ($nonRefundable == "true") {
            ...
            $item['cancelpolicy'] = $translator->translate("This is a non refundable booking.") . "<br/>" . $cancelation_string;
            $item['cancelpolicy_details'] = $translator->translate("This is a non refundable booking.") . "<br/>" . $cancelation_string;
