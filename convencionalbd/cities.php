...
$getCityListResponse = $Body->item(0)->getElementsByTagName("getCityListResponse");
$getCityListResult = $getCityListResponse->item(0)->getElementsByTagName("getCityListResult");
$Cities = $getCityListResult->item(0)->getElementsByTagName("Cities");
