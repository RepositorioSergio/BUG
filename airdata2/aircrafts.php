...
$string = file_get_contents("aircrafts.json");
$response = json_decode($string, true);
foreach ($response as $key => $value) {
    $codeIataAircraft = $value['codeIataAircraft'];
    $nameAircraft = $value['nameAircraft'];
    $planeTypeId = $value['planeTypeId'];
    //echo $id . "ID<br/>";
    ...
    $insert->into('aircrafts');
        $insert->values(array(
            'codeiataaircraft' => $codeIataAircraft,
