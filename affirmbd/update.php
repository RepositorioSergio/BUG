...
$url = "https://sandbox.affirm.com/api/v2/charges/G8QC-ZIAI/update";
$order_id = "123456789";
...
$type = $response['type'];
$shipping_confirmation = $response['shipping_confirmation'];
$shipping_carrier = $response['shipping_carrier'];
