...
$raw= '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:env="http://www.w3.org/2003/05/soap-envelope" xmlns="http://www.juniper.es/webservice/2007/">
<soapenv:Body>
  <HotelBooking>
    <HotelBookingRQ Version="1.1" Language="en">
      ...
      <Elements>
        <HotelElement>
          ...
          <HotelBookingInfo Start="2020-06-20" End="2020-06-22">
            <Price>
              <PriceRange Minimum="' . $minimum . '" Maximum="' . $maximum . '" Currency="EUR"/>
            </Price>
