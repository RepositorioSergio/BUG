...
if ($city_xml11 != "") {
    ...
    for ($r = 0; $r < $rooms; $r ++) {
        ...
        // ItemCode
        // Add rooms
        $xmlrequest .= '<IncludeRecommended /><IncludePriceBreakdown /><IncludeChargeConditions /><PaxRooms>';
        $cots = 0;
        ...
        $xmlrequest .= '<PaxRoom Adults="' . $selectedAdults[$r] . '" Cots="' . $cots . '" RoomIndex="1">';
        if ($selectedChildren[$r] > 0) {
                    ...
                    foreach ($hotelElements as $hotelElement) {
                        ...
                        foreach ($PaxRoomSearchResults as $PaxRoomSearchResult) {
                            ...
                            foreach ($hotelElementsExtra as $hotelElementExtra) {
                                ...
                                $tmp[$shid]['details'][$zRooms][$baseCounterDetails]['room'] = ucwords(strtolower($roomdescription));
                                ...
                                $tmp[$shid]['details'][$zRooms][$baseCounterDetails]['cots'] = "";
                                $tmp[$shid]['details'][$zRooms][$baseCounterDetails]['nrextrabeds'] = 0;
                                if ($EssentialInformation != "") {
