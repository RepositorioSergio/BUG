...
<soap:Body>
    <hot:AmendmentRequest>
        ...
        <hot:AmendInformation>
            <hot:CheckIn Date="2017-07-28"/>
            <hot:CheckOut Date="2017-07-29"/>
            <hot:Rooms>
                <hot:RoomReq Amend="FirstRoom">
                    ...
                    <hot:Guest Action="Rename" ExistingName="Mr Kuldap testhb" GuestType="Adult" Title="Mr." FirstName="Shyam" LastName="Srivastav" Age="25"/>
                    <hot:Guest Action="Delete" ExistingName="Mr Kuld adulttwo" GuestType="Adult" Age="0"/>
                </hot:RoomReq>
            </hot:Rooms>
        </hot:AmendInformation>
