...
use Zend\Log\Logger;
use Zend\Log\Writer;
echo "COMECOU CANCELPOLICIES ALL<br/>";
...
<wsa:Action>http://TekTravel/HotelBookingApi/HotelCancellationPolicyForAllRooms</wsa:Action>
<wsa:To>https://api.tbotechnology.in/hotelapi_v7/hotelservice.svc</wsa:To>
</soap:Header>
<soap:Body>
< hot:HotelCancellationPolicyRequest>
< hot:ResultIndex>28</ hot:ResultIndex>
< hot:SessionId>77f8721a-137b-4f2a-a6cb-4e13cb2b852d</ hot:SessionId>
</ hot:HotelCancellationPolicyRequest>
</soap:Body>
</soap:Envelope>';
