...
$url = 'http://testxml.youtravel.com/webservicestest/get_destinations.asp?LangID=EN&Username=xmltestme&Password=testme';
    ...
    for ($i=0; $i < $Country->length; $i++) { 
        ...
        if ($Destination->length > 0) {
            for ($j=0; $j < $Destination->length; $j++) { 
                ...
                if ($Resort->length > 0) {
                    $ID = $Resort->item(0)->getAttribute("ID");

                    $Resort_Name = $Resort->item(0)->getElementsByTagName("Resort_Name");
