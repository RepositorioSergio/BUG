...
$url = 'http://testxml.youtravel.com/webservicestest/get_canx_fees.asp?Booking_ref=101464305&Username=xmltestme&Password=testme';
...
$Fees = $HtSearchRq->item(0)->getElementsByTagName("Fees");
if ($Fees->length > 0) {
    $Fees = $Fees->item(0)->nodeValue;
} else {
    $Fees = "";
}
$Currency = $HtSearchRq->item(0)->getElementsByTagName("Currency");
