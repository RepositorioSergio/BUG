...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <soap:Body>
    <HoldCabin xmlns="http://schemas.costacrociere.com/WebAffiliation">
        <components>
            <Component>
            <Type>Cruise</Type>
...
$client->setHeaders(array(
    ...
    "Accept: text/xml",
    "SOAPAction: http://schemas.costacrociere.com/WebAffiliation/HoldCabin",
...
if ($HoldCabinResponse->length > 0) {
    $HoldCabinResult = $HoldCabinResponse->item(0)->getElementsByTagName("HoldCabinResult");
    if ($HoldCabinResult->length > 0) {
        $Cabin = $HoldCabinResult->item(0)->getElementsByTagName("Cabin");
        if ($Cabin->length > 0) {
