...
$sql = "SELECT id FROM destinationsCountry";
...
if ($result instanceof ResultInterface && $result->isQueryResult()) {
    ...
    foreach ($resultSet as $row) {
        ...
        $url = "http://demo.gl-tours.com/packages_to_xml.php?Action=getTypeByDestination&Destination=$destinationId&User=TEST&Pass=1234 ";
