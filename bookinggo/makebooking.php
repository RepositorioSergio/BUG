...
$raw = '<MakeBookingRQ version="1.1" insuranceVersion="2.0" correlationId="54tfg-ryiu-332-182-dsd0">
...
<Booking>
    ...
    <ExtraList>
        <Extra id="10000000421011" amount="62"/>
    </ExtraList>
    <Vehicle id="674412831"/> 
    <DriverInfo>
        <DriverName title="mr" firstname="tester" lastname="test"/> <Address country="UK" city="London" street="Street name"postcode="L1 2AB"/> 
    ...
    <AirlineInfo flightNo="ABC 1234"></AirlineInfo> <AcceptedPrice price="68.00" currency="GBP"/>
</Booking>
</MakeBookingRQ>';
