...
$raw = '<CancelBookingRQ>
    ...
    <Reason>Flight cancelled.</Reason>
</CancelBookingRQ>';
...
$CancelBookingRS = $inputDoc->getElementsByTagName("CancelBookingRS");
if ($CancelBookingRS->length > 0) {
    $Status = $CancelBookingRS->item(0)->getElementsByTagName("Status");
    if ($Status->length > 0) {
