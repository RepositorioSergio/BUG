...
function readCSV(string $filename){
    ...
    while ($data = fgetcsv($object, 0, "|")) {
        if ($line > 0) {
            ...
            $shortdescription_es_es = $data[2];
            $longdescription_en_us = $data[3];
            $longdescription_es_es = $data[4];
            $timestamp = $data[5];
            ...
            $shortdescription_es_es = str_replace('"', '', $shortdescription_es_es);
            $shortdescription_es_es = mb_convert_encoding($shortdescription_es_es, "UTF-8");
            ...
            $longdescription_es_es = str_replace('"', '', $longdescription_es_es);
            $longdescription_es_es = mb_convert_encoding($longdescription_es_es, "UTF-8");
            $productstatus = str_replace('"', '', $productstatus);

            try {
                $sql = new Sql($db);
                $insert = $sql->insert();
                $insert->into('descriptions_es_es');
                $insert->values(array(
                    'hotelid' => $hotelid,
                    'shortdescription_en_us' => $shortdescription_en_us, 
                    'shortdescription_es_es' => $shortdescription_es_es, 
                    'longdescription_en_us' => $longdescription_en_us,
                    'longdescription_es_es' => $longdescription_es_es, 
                    'timestamp' => $timestamp, 
