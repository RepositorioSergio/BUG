...
function readCSV(string $filename){
    ...
    while ($data = fgetcsv($object, 0, "|")) {
        if ($line > 0) {
            ...
            $shortdescription_he_il = $data[2];
            $longdescription_en_us = $data[3];
            $longdescription_he_il = $data[4];
            $timestamp = $data[5];
            ...
            $shortdescription_he_il = str_replace('"', '', $shortdescription_he_il);
            $shortdescription_he_il = mb_convert_encoding($shortdescription_he_il, "UTF-8");
            ...
            $longdescription_he_il = str_replace('"', '', $longdescription_he_il);
            $longdescription_he_il = mb_convert_encoding($longdescription_he_il, "UTF-8");
            $productstatus = str_replace('"', '', $productstatus);

            try {
                $sql = new Sql($db);
                $insert = $sql->insert();
                $insert->into('descriptions_he_il');
                $insert->values(array(
                    'hotelid' => $hotelid,
                    'shortdescription_en_us' => $shortdescription_en_us, 
                    'shortdescription_he_il' => $shortdescription_he_il, 
                    'longdescription_en_us' => $longdescription_en_us,
                    'longdescription_he_il' => $longdescription_he_il, 
                    'timestamp' => $timestamp, 
