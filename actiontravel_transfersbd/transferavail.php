...
<soapenv:Header/>
<soapenv:Body>
   <TransferAvail xmlns="http://www.juniper.es/webservice/2007/">
      <TransferAvailRQ Version="1.1" Language="en">
         ...
         <TransferRequest>
            <SearchSegmentsTransfers>
               <SearchSegmenTransfers Start="2020-08-17" Hour="10:00:00" End="2020-08-24" HourEnd="12:00:00" OriginZone="40233" DestinationZone="15011" Route="InOut" />
            </SearchSegmentsTransfers>
            <RelPaxesDist>
               <RelPaxDist>
                  <RelPaxes>
...
$headers = array(
    ...
    "SOAPAction: http://www.juniper.es/webservice/2007/TransferAvail",
        ...
        if ($Results->length > 0) {
            ...
            if ($TransferResult->length > 0) {
                for ($i=0; $i < $TransferResult->length; $i++) { 
                    ...
                    $RatePlanCode = $TransferResult->item($i)->getAttribute("RatePlanCode");
                    //TransferInfo
