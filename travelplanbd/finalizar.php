...
$raw = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:typ="types.reserva.wst">     <soapenv:Header/>     <soapenv:Body>        <typ:finalizarReservaRequest>           <typ:idUsuario>' . $globaliapackagesCustomerID . '</typ:idUsuario>           <!--Optional:-->           <typ:expediente>1000000002</typ:expediente>           <!--Optional:-->           <typ:codTcy/>           <!--Optional:-->          <typ:agencia/>           <!--Optional:-->           <typ:sucursal/>           <typ:ideSes>' . $ideSes . '</typ:ideSes>        </typ:finalizarReservaRequest>     </soapenv:Body>  </soapenv:Envelope>';
$client = new Client();
