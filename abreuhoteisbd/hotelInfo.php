...
$raw = '<?xml version="1.0" encoding="utf-8"?><soap-env:Envelope xmlns:soap-env="http://schemas.xmlsoap.org/soap/envelope/">     <soap-env:Header>         <wsse:Security xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wsswssecurity-secext-1.0.xsd">             <wsse:Username>' . $AbreuUsername . '</wsse:Username>             <wsse:Password>' . $Abreupassword . '</wsse:Password>             <Context>' . $AbreuContext . '</Context>         </wsse:Security>     </soap-env:Header>     <soap-env:Body>         <OTA_HotelInfoRQ xmlns="http://www.opentravel.org/OTA/2003/05/common" LanguageId="EN">             <HotelRef HotelCode="2664491"/>         </OTA_HotelInfoRQ>     </soap-env:Body> </soap-env:Envelope';
...
$client->setUri($AbreuHOTELAVAILABILITY);
