...
xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 <SOAP-ENV:Body>
 <m:GetServices xmlns:m="http://www.majesticusa.com/majesticweb_xml/">
 <m:Id>0</m:Id>
 <m:Sort>service</m:Sort>
 <m:GetMealPlan xmlns="http://www.majesticusa.com/majesticweb_xml/">
</m:GetServices>
 </SOAP-ENV:Body>
</SOAP-ENV:Envelope>';
...
$GetProductResponse = $Body->item(0)->getElementsByTagName("GetProductResponse");
$GetProductResult = $GetProductResponse->item(0)->getElementsByTagName("GetProductResult");
$Root = $GetProductResult->item(0)->getElementsByTagName("Root");
$node = $Root->item(0)->getElementsByTagName("MealPlan");
echo $return;
    ...
    try {
        ...
        if ($result->valid()) {
            ...
            if ($id > 0) {
                ...
                $where['Id = ?'] = $Id;
                $update = $sql->update('mealplan', $data, $where);
                $db->getDriver()
                    ->getConnection()
                    ->disconnect();
            } else {
