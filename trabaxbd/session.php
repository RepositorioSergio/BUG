...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:cir="http://circuito.serviceIncoming.dome.com/">
   ...
   <soapenv:Body>
      ...
      <arg0>
        <codage>11</codage>
        <pasusu>CTM123456</pasusu>
        <codsys>AGH</codsys>
        <idtusu>CTM123456</idtusu>
        </arg0>
      </cir:sesionAbrir>
   </soapenv:Body>
</soapenv:Envelope>';
...
$sesionAbrirResponse = $Body->item(0)->getElementsByTagName("sesionAbrirResponse");
$return2 = $sesionAbrirResponse->item(0)->getElementsByTagName("return");
