...
use Zend\Log\Logger;
use Zend\Log\Writer;
echo "COMECOU CONFIRM BASKET<br/>";
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:typ="http://xtravelsystem.com/v1_0rc1/basket/types">
   <soapenv:Header/>
   <soapenv:Body>
      <typ:confirmBasketV22>
         <ConfirmRQExtendsV22_1>
            <agencyCode>266333</agencyCode>
            <brandCode>1</brandCode>
            <pointOfSaleId>1</pointOfSaleId>
            <basketId>8275272216</basketId>
            <userId></userId>
            <agencyReference>testtestttest</agencyReference>
            <!--Zero or more repetitions:-->
            <comment></comment>
            <sendDocumentationTo>testemail@gmail.com</sendDocumentationTo>
            ...
            <paxList>
               ...
               <roomTypeCode>1P1</roomTypeCode>
               <serviceId>11250858</serviceId>
            </paxList>
         </ConfirmRQExtendsV22_1>
      </typ:confirmBasketV22>
   </soapenv:Body>
...
$cancelResponse = $Body->item(0)->getElementsByTagName("cancelResponse");
if ($cancelResponse->length > 0) {
    $result = $cancelResponse->item(0)->getElementsByTagName("result");
    if ($result->length > 0) {
