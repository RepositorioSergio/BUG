...
if ($result instanceof ResultInterface && $result->isQueryResult()) {
    ...
    foreach ($resultSet as $row) {
        ...
        $getAirportsResponse = $Body->item(0)->getElementsByTagName("getAirportsResponse");
        if ($getAirportsResponse->length > 0) {
            $result = $getAirportsResponse->item(0)->getElementsByTagName("result");
            if ($result->length > 0) {
