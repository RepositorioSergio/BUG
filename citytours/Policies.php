...
try {
    ...
    $sql = "select data, searchsettings, xmlrequest, xmlresult from quote_session_citytours where session_id='$session_id'";
...
if ((int) $nationality > 0) {
    ...
    $sql = "select value from settings where name='citytoursDefaultNationalityCountryCode' and affiliate_id=$affiliate_id_citytours" . $branch_filter;
    ;
    $statement = $db->createStatement($sql);
    $statement->prepare();
    $row_settings = $statement->execute();
...
$sql = "select value from settings where name='citytoursID' and affiliate_id=$affiliate_id_citytours" . $branch_filter;
;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
...
$sql = "select value from settings where name='citytoursPassword' and affiliate_id=$affiliate_id_citytours" . $branch_filter;
;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
...
$sql = "select value from settings where name='citytoursMarkup' and affiliate_id=$affiliate_id_citytours" . $branch_filter;
;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
...
$sql = "select value from settings where name='citytoursServiceURL' and affiliate_id=$affiliate_id_citytours" . $branch_filter;
;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
...
$sql = "select value from settings where name='citytoursAgencyCode' and affiliate_id=$affiliate_id_citytours" . $branch_filter;
;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
...
$sql = "select value from settings where name='citytoursSystem' and affiliate_id=$affiliate_id_citytours" . $branch_filter;
;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
...
$db = new \Zend\Db\Adapter\Adapter($config);
$hotel = array();
$sql = "select sid from xmlhotels_mcitytours where sid='" . $shid . "' and hid=" . $hid;
$statement = $db->createStatement($sql);
try {
    $statement->prepare();
} catch (Exception $e) {
