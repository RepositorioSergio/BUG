...
if ($result instanceof ResultInterface && $result->isQueryResult()) {
    ...
    foreach ($resultSet as $row) {
        ...
        <soapenv:Header/>
        <soapenv:Body>
            <tms:catalogoZona soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
        ...
        echo $return;
        echo $return;
        $client->setUri('http://wwwaps.panavision-tours.es/integracionAme/TmsApi?invoke=catalogoZona&xml=<consulta><zona>' . $idzona . '</zona></consulta>');
