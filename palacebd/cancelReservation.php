...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <soap:Body>
    <CancelReservationByReference xmlns="http://localhost/xmlschemas/enterpriseservice/16-07-2009/">
      <mreservationRequest xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/mreservationRequest.xsd">
        <CompanyID></CompanyID>
        <MemberID></MemberID>
        <IncludeGolf>false</IncludeGolf>
        <IsPublicReservation>false</IsPublicReservation>
        <Data>
          <referred xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">false</referred>
          <Folio xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">12279717</Folio>
          <Hotel xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">MPG</Hotel>
          <Room_Type xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">RV</Room_Type>
          <Bed_Type xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">D</Bed_Type>
          <Arv_Date xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">2019-09-23T00:00:00</Arv_Date>
          ...
          <Guest_Type xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd"></Guest_Type>
          <Ent_User xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">CTM-PERU</Ent_User>
          <Ent_Term xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">CTM-PERU</Ent_Term>
          <specialRequirements xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">
            <specialRequirement xsi:nil="true" />
            <specialRequirement xsi:nil="true" />
          </specialRequirements>
          <Amount xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">decimal</Amount>
          <provision_member xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">
            <type></type>
            <folio></folio>
            <weekType></weekType>
          </provision_member>
          <Origen xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">None</Origen>
          <IdProfileOpera xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd"></IdProfileOpera>
          <Promo xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd"></Promo>
        </Data>
        <Data_multiple>
          <reservation>
            <referred xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">false</referred>
            ...
            <Arv_Date xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">2019-09-23T00:00:00</Arv_Date>
            <Nights xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">5</Nights>
            <Pax xsi:nil="true" xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd" />
            <Name xsi:nil="true" xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd" />
            <Share1 xsi:nil="true" xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd" />
            <Share2 xsi:nil="true" xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd" />
            <Share3 xsi:nil="true" xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd" />
            <Guest_Type xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd"></Guest_Type>
            <Ent_User xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">CTM-PERU</Ent_User>
            <Ent_Term xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">CTM-PERU</Ent_Term>
            <specialRequirements xsi:nil="true" xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd" />
            <Amount xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">1445</Amount>
            <provision_member xsi:nil="true" xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd" />
            <Origen xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd">None</Origen>
            <IdProfileOpera xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd"></IdProfileOpera>
            <Promo xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/reservation.xsd"></Promo>
          </reservation>
        ...
        <PrivateReference></PrivateReference>
        <GuestNote></GuestNote>
        ...
        <RateDetailDays>
          <RateDetailDay>
            <RateCode xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/RateDetailDay.xsd">TLAV15I</RateCode>
            <EffectiveDateRate xmlns="http://localhost/pr_xmlschemas/hotel/01-03-2006/RateDetailDay.xsd">2019-09-23T00:00:00</EffectiveDateRate>
          </RateDetailDay>
        </RateDetailDays>
        <Tag></Tag>
        <AuthInfo>
