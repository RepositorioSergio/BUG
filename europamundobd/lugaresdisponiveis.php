...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <getPlazasDisponibles xmlns="http://tempuri.org/">
      <IdViaje>17480</IdViaje>
      <Fecha>20190630</Fecha>
...
$getPlazasDisponiblesResponse = $Body->item(0)->getElementsByTagName("getPlazasDisponiblesResponse");
$getPlazasDisponiblesResult = $getPlazasDisponiblesResponse->item(0)->getElementsByTagName("getPlazasDisponiblesResult");
if ($getPlazasDisponiblesResult->length > 0) {
    $getPlazasDisponiblesResult = $getPlazasDisponiblesResult->item(0)->nodeValue;
} else {
    $getPlazasDisponiblesResult = "";
}
