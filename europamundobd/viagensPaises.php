...
$db = new \Zend\Db\Adapter\Adapter($config);
echo strtotime('2019-08-03T09:06:41.187');
...
if ($result instanceof ResultInterface && $result->isQueryResult()) {
    ...
    foreach ($resultSet as $row) {
        ...
        <soap:Body>
            <getViajesByPais xmlns="http://tempuri.org/">
            <Paises>
                <string>' . $PAIS . '</string>
            </Paises>
