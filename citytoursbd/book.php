...
<soap:Body>
  <ServiceReservation xmlns="http://tempuri.org/">
<OTA_TourActivityBookRQ AltLangID="en-us" Version="3.0" xmlns="http://www.opentravel.org/OTA/2003/05" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
<POS>
...
<UniqueID BrokerCode="7" />
<BookingInfo>
  <BasicInfo Name="Canada Magnifico con New York" TourActivityContractAvailID="6383" TourActivityContractPriceID="10982" TourActivityID="1121"/>
  <CategoryAndType>
    <Type Code="3">Circuit</Type>
  </CategoryAndType>
  <ParticipantInfo>
    <Category Age="28" Quantity="1" ParticipantCategoryID="Main">
      <QualifierInfo>Adult</QualifierInfo>
    </Category>
    <Individual Age="28" Gender="Male" Language="" Nationality="">
      <Document DocID="123456789" DocType="RG"/>
      <GivenName>Juciel</GivenName>
      <MiddleName>Santos</MiddleName>
  ...
  <ParticipantInfo>
    <Category Age="7" Quantity="1">
      <QualifierInfo>Child</QualifierInfo>
    </Category>
    <Individual Age="8" Gender="Male" Language="" Nationality="">
      <Document DocID="123456789" DocType="RG"/>
  ...
  <Schedule Duration="11" Start="2019-04-12"/>
  <Location>
    <Address>
  ...
  <TourActivityRooms>
    <TourActivityRoom TourActivityRoomTypeID="10"/>
  </TourActivityRooms>
  <TourActivityAdditionalServices>
    <TourActivityAdditionalService TourActivityAdditionalServiceID="1086" TourActivityAdditionalServiceServiceID="830" TourActivityDay="1" AdditionalServiceDate="2019-04-12">
      <TourActivityAdditionalServiceCode>NYCCOMTRASCP</TourActivityAdditionalServiceCode>
      <TourActivityAdditionalServiceDescription/>
      <TourActivityAdditionalServiceName>Traslado Aeropuerto  DIURNO - Llegada</TourActivityAdditionalServiceName>
      <TourActivityAdditionalServiceTypeID>4</TourActivityAdditionalServiceTypeID>
      <TourActivityAdditionalServiceType>Transfer</TourActivityAdditionalServiceType>
      <TourActivityAdditionalServiceAirSegment ArrivalDateTime="2019-04-12" ArrivalHour="21:00" DepartureDateTime="2019-04-12" DepartureHour="19:00">
        <DepartureAirport CodeContext="IATA" LocationCode="GRU"/>
        <ArrivalAirport CodeContext="IATA" LocationCode="JFK"/>
        <OperatingAirline Code="JJ" CodeContext="IATA" CompanyShortName="TAM" FlightNumber="JJ3756"/>
        <ArrivalLocation>
          <Address>
            <CityName>New York City</CityName>
    ...
    </TourActivityAdditionalService>
    <TourActivityAdditionalService TourActivityAdditionalServiceID="1088" TourActivityAdditionalServiceServiceID="831" TourActivityDay="11"  AdditionalServiceDate="2019-04-12">
      <TourActivityAdditionalServiceCode>NYCCOMTRASSCP</TourActivityAdditionalServiceCode>
      <TourActivityAdditionalServiceDescription/>
      <TourActivityAdditionalServiceName>Traslado Hotel al Aeropuerto NYC - DIURNO - Salida</TourActivityAdditionalServiceName>
      <TourActivityAdditionalServiceTypeID>4</TourActivityAdditionalServiceTypeID>
      <TourActivityAdditionalServiceType>Transfer</TourActivityAdditionalServiceType>
      <TourActivityAdditionalServiceAirSegment ArrivalDateTime="2019-04-23" ArrivalHour="10:00" DepartureDateTime="2019-04-23" DepartureHour="14:00">
        <DepartureAirport CodeContext="IATA" LocationCode="JFK"/>
        <ArrivalAirport CodeContext="IATA" LocationCode="GRU"/>
        <OperatingAirline Code="JJ" CodeContext="IATA" CompanyShortName="TAM" FlightNumber="JJ3488"/>
        <ArrivalLocation>
          <Address>
            <CityName>New York City</CityName>
            <StateProv StateCode="NY">New York</StateProv>
...
$client->setHeaders(array(
    ...
    "Pragma: no-cache",
    "SOAPAction: http://tempuri.org/ServiceReservation",
...
$OTA_TourActivityBookRS = $Body->item(0)->getElementsByTagName("OTA_TourActivityBookRS");
