...
if ($details == "hoteldetails") {
    // Detail level
    $sql = "select data, searchsettings, xmlrequest, xmlresult from quote_session_convencional where session_id='" . $session_id . "-" . $index . "'";
} else {
    $sql = "select data, searchsettings, xmlrequest, xmlresult from quote_session_convencional where session_id='$session_id'";
}
try {
...
$affiliate_id = 0;
$branch_filter = '';
$sql = "select value from settings where name='enableconvencional' and affiliate_id=$affiliate_id" . $branch_filter;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
$row_settings->buffer();
...
$sql = "select value from settings where name='convencionalLogin' and affiliate_id=$affiliate_id_convencional" . $branch_filter;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
$row_settings->buffer();
...
$sql = "select value from settings where name='convencionalPassword' and affiliate_id=$affiliate_id_convencional" . $branch_filter;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
$row_settings->buffer();
...
$sql = "select value from settings where name='convencionalMarkup' and affiliate_id=$affiliate_id_convencional" . $branch_filter;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
$row_settings->buffer();
...
$sql = "select value from settings where name='convencionalName' and affiliate_id=$affiliate_id_convencional" . $branch_filter;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
$row_settings->buffer();
...
$sql = "select value from settings where name='convencionalID' and affiliate_id=$affiliate_id_convencional" . $branch_filter;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
$row_settings->buffer();
...
$sql = "select value from settings where name='convencionalServiceURL' and affiliate_id=$affiliate_id_convencional" . $branch_filter;
$statement = $db->createStatement($sql);
$statement->prepare();
$row_settings = $statement->execute();
$row_settings->buffer();
...
$hotel = array();
$sql = "select sid from xmlhotels_mconvencional where sid='" . $shid . "' and hid=" . $hid;
$statement = $db->createStatement($sql);
try {
    $statement->prepare();
} catch (Exception $e) {
