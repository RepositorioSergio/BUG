...
$CPAId = 'IA8H';
$BinarySecurityToken = 'Shared/IDL:IceSess\/SessMgr:1\.0.IDL/Common/!ICESMS\/ACPCRTD!ICESMSLB\/CRT.LB!1586335061046!5114!9';
$RPH = '001';
...
<soapenv:Body>
  <OTA_HotelResRQ Version="2.2.0" xmlns="http://webservices.sabre.com/sabreXML/2011/10" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
      <Hotel>
         <BasicPropertyInfo RPH="' . $RPH . '"/>
         <Guarantee Type="GDPST">
            <CC_Info>
               <PaymentCard Code="VI" ExpireDate="2022-12" Number="4400661815400699"/>
               <PersonName>
                  <Surname>Jee</Surname>
               </PersonName>
            </CC_Info>
