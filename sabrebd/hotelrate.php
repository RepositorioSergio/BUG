...
$CPAId = 'IA8H';
$BinarySecurityToken = 'Shared/IDL:IceSess\/SessMgr:1\.0.IDL/Common/!ICESMS\/ACPCRTD!ICESMSLB\/CRT.LB!1586512959772!7997!13';
...
<soapenv:Header>
   <sec:Security>
      ...
      <sec:UsernameToken>
         <!--Optional:-->
         <sec:Username>7971</sec:Username>
         <!--Optional:-->
         <sec:Password>WS121414</sec:Password>
         <!--Optional:-->
         <Organization>IA8H</Organization>
         <!--Optional:-->
         <Domain>AA</Domain>
      </sec:UsernameToken>
      <!--Optional:-->
   ...
   <mes:MessageHeader>
      <mes:From>
         ...
         <mes:PartyId>111</mes:PartyId>
      </mes:From>
      <mes:To>
         <!--1 or more repetitions:-->
         <mes:PartyId>222</mes:PartyId>
      </mes:To>
      <mes:CPAId>IA8H</mes:CPAId>
      <mes:ConversationId>333</mes:ConversationId>
      <mes:Service>HotelRateDescriptionLLSRQ</mes:Service>
      <mes:Action>HotelRateDescriptionLLSRQ</mes:Action>
      <mes:MessageData>
         <mes:MessageId>mid:20001209-133003-2333@clientofsabre.com</mes:MessageId>
         <mes:Timestamp>' . $datetime . '</mes:Timestamp>
      </mes:MessageData>
   </mes:MessageHeader>
</soapenv:Header>
<soapenv:Body>
   <ns:HotelRateDescriptionRQ Version="2.3.0">
      <ns:AvailRequestSegment>
         ...
         <ns:HotelSearchCriteria>
            <ns:Criterion>
               <ns:HotelRef HotelCode="0050645"/>
            </ns:Criterion>
         </ns:HotelSearchCriteria>
         <!--Optional:-->
        <ns:RatePlanCandidates>
            <ns:RatePlanCandidate CurrencyCode="USD" RPH="001"/>
        </ns:RatePlanCandidates>
         <!--Optional:-->
         <ns:TimeSpan End="11-24" Start="11-22"/>
      </ns:AvailRequestSegment>
