...
<SOAP-ENV:Header>
    <eb:MessageHeader eb:version="3.0.0" xmlns:eb="http://www.ebxml.org/namespaces/messageHeader">
        ...
        <eb:Action>GetHotelRateInfoRQ</eb:Action>
        <eb:MessageData>
...
<SOAP-ENV:Body>
   <GetHotelRateInfoRQ xmlns="http://services.sabre.com/hotel/rate/v3_0_0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="3.0.0" xsi:schemaLocation="http://services.sabre.com/hotel/rate/v3_0_0 GetHotelRateInfoRQ_V3.xsd">
  <HotelRefs>
...
$GetHotelRateInfoRS = $Body->item(0)->getElementsByTagName("GetHotelRateInfoRS");
if ($GetHotelRateInfoRS->length > 0) {
    $HotelRateInfos = $GetHotelRateInfoRS->item(0)->getElementsByTagName("HotelRateInfos");
