...
use Zend\Log\Logger;
use Zend\Log\Writer;
echo "COMECOU HOTEL DESCRIPTIVE<br/>";
...
<SOAP-ENV:Header>
    <eb:MessageHeader eb:version="3.0.0" xmlns:eb="http://www.ebxml.org/namespaces/messageHeader">
        ...
        <eb:Action>GetHotelDescriptiveInfoRQ</eb:Action>
        <eb:MessageData>
            <eb:MessageId>LbQ26Jnofb4Q8f3Pk15Mg5</eb:MessageId>
            <eb:Timestamp>2020-04-13T17:30:50</eb:Timestamp>
        </eb:MessageData>
            </eb:MessageHeader>
        <wsse:Security xmlns:wsse="http://schemas.xmlsoap.org/ws/2002/12/secext">
        <wsse:BinarySecurityToken>Shared/IDL:IceSess\/SessMgr:1\.0.IDL/Common/!ICESMS\/ACPCRTC!ICESMSLB\/CRT.LB!1586801223696!9348!13</wsse:BinarySecurityToken>
    </wsse:Security>
</SOAP-ENV:Header>
<SOAP-ENV:Body>
   <GetHotelDescriptiveInfoRQ xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://services.sabre.com/hotel/descriptiveinfo/v3" version="3.0.0" xsi:schemaLocation="http://services.sabre.com/hotel/descriptiveinfo/v3 GetHotelDescriptiveInfoRQ_v3.xsd">
  <POS>
...
$GetHotelDescriptiveInfoRS = $Body->item(0)->getElementsByTagName("GetHotelDescriptiveInfoRS");
if ($GetHotelDescriptiveInfoRS->length > 0) {
    $HotelDescriptiveInfos = $GetHotelDescriptiveInfoRS->item(0)->getElementsByTagName("HotelDescriptiveInfos");
    if ($HotelDescriptiveInfos->length > 0) {
        $HotelDescriptiveInfo = $HotelDescriptiveInfos->item(0)->getElementsByTagName("HotelDescriptiveInfo");
        if ($HotelDescriptiveInfo->length > 0) {
            $HotelInfo = $HotelDescriptiveInfo->item(0)->getElementsByTagName("HotelInfo");
