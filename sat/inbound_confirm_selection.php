...
use Zend\Log\Logger;
use Zend\Log\Writer;
echo "COMECOU INBOUND CONFIRM SELECTION<br/>";
...
$inbound_selected_result = $response['inbound_selected_result'];
$id = $inbound_selected_result['id'];
$departure_datetime = $inbound_selected_result['departure_datetime'];
$arrival_datetime = $inbound_selected_result['arrival_datetime'];
$duration = $inbound_selected_result['duration'];
$best_price = $inbound_selected_result['best_price'];
$kind = $inbound_selected_result['kind'];
$changes_count = $inbound_selected_result['changes_count'];
$route = $inbound_selected_result['route'];
$origin_station = $route['origin_station'];
$origin_station_uid = $origin_station['uid'];
$names = $origin_station['names'];
for ($i=0; $i < count($names); $i++) { 
...
$seat_preference = $inbound_selected_result['seat_preference'];
$currency = $seat_preference['currency'];
$amount = $seat_preference['amount'];
$status = $seat_preference['status'];
$options = $seat_preference['options'];
