...
use Zend\Log\Logger;
use Zend\Log\Writer;
echo "COMECOU RESERVE PAY AND CONFIRM<br/>";
...
$method = "POST";
$path = "/booking.json/guest/{sessionId}/reserve-pay-confirm";
...
$client->setUri($url . '/booking.json/guest/{sessionId}/reserve-pay-confirm');
