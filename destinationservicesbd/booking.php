...
$method = "GET";
$path = "/booking.json/booking/DS-8509143?currency=USD&lang=EN";
...
$client->setUri($url . '/booking.json/activity-booking/DS-8509143?currency=USD&lang=EN');
...
$totalDueAsText = $response['totalDueAsText'];
