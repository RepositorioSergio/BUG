...
use Zend\Log\Logger;
use Zend\Log\Writer;
echo "COMECOU AVAILABILITIES ACCOMMODATION<br/>";
...
$method = "GET";
$path = "/accommodation.json/availabilities?ids=22777&start=2019-12-10&end=2019-12-12&lang=EN&currency=USD";
...
$client->setUri($url . '/accommodation.json/availabilities?ids=22777&start=2019-12-10&end=2019-12-12&lang=EN&currency=USD');
