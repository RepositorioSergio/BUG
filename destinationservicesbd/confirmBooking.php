...
$method = "POST";
$path = "/booking.json/DS-8509143/confirm?currency=USD&lang=EN&sendCustomerNotification=true";
...
$raw = '{
    "externalBookingReference": "DS-8509143",
    "payment": {
      "activeCustomerInvoiceId": 16898662,
      "amount": 902.63,
      "currency": "USD",
...
$client->setUri($url . '/booking.json/DS-8509143/confirm');
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url . '/booking.json/DS-8509143/confirm?currency=USD&lang=EN&sendCustomerNotification=true');
...
$externalBookingReference = $response['externalBookingReference'];
$externalBookingEntityName = $response['externalBookingEntityName'];
$externalBookingEntityCode = $response['externalBookingEntityCode'];
...
$totalPriceConverted = $response['totalPriceConverted'];
...
//activityBookings
$activityBookings = $response['activityBookings'];
...
//bookingChannel
$bookingChannel = $response['bookingChannel'];
...
//bookingFields
$bookingFields = $response['bookingFields'];
if (count($bookingFields) > 0) {
    for ($rAux=0; $rAux < count($bookingFields); $rAux++) { 
        $name = $bookingFields[$rAux]['name'];
        $value = $bookingFields[$rAux]['value'];
...
//extranetUser
$extranetUser = $response['extranetUser'];
//harbour
$harbour = $response['harbour'];
...
//routeBookings
$routeBookings = $response['routeBookings'];
//seller
